...
export default function CosmicLoader({
        ...
        <div className="flex flex-col items-center justify-center relative z-50">
            ...
            <div className={`relative flex items-center justify-center ${s.container}`}>
                ...
                <motion.div
                    ...
                    className={`absolute inset-4 rounded-full border border-dotted border-amber-400/40`}
                />
    ...
    if (fullscreen) {
        return (
            <div className={`fixed inset-0 z-[9999] flex items-center justify-center ${transparent ? "bg-black/80 backdrop-blur-sm" : "bg-[#0b1026]"}`}>
                <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_center,_var(--tw-gradient-stops))] from-indigo-900/40 via-[#0b1026] to-black pointer-events-none"></div>
