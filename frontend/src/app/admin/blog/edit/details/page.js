...
export default function AdminEditPostWrapper() {
    return (
        <Suspense fallback={<div className="flex justify-center items-center min-h-screen"><div className="animate-spin rounded-full h-12 w-12 border-t-2 border-b-2 border-slate-800"></div></div>}>
            <AdminEditPost />
        </Suspense>
    );
}
...
function AdminEditPost() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            await API.put(`/blog/posts/${postId}`, form);
