...
export default function AdminAstrologerDetails() {
    const { slug } = useParams(); // Using slug (name) from URL
    const { user } = useAuth();
                            ...
                            <div className="flex-1 text-center md:text-left space-y-6 pt-2">
                                ...
                                <div className="space-y-4">
                                    ...
                                    <div className="flex justify-center md:justify-start gap-4 pt-2">
                                        <button
                                            onClick={() => astroData.userId && router.push(`/admin/users/${astroData.userId.username || astroData.userId._id || astroData.userId}`)}
