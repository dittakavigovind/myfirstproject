...
import { ArrowLeft, Mail, Shield, Trash2, User as UserIcon, AlertCircle, Sparkles, Star, Phone, Activity } from 'lucide-react';
import Link from 'next/link';
import toast from 'react-hot-toast';

export default function AdminAstrologerSlugPage({ params }) {
