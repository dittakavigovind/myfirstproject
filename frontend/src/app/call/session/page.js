...
export default function CallPageWrapper() {
    return (
        <Suspense fallback={<div className="min-h-screen bg-gray-900 flex flex-col items-center justify-center relative overflow-hidden text-white">Connecting...</div>}>
            <CallPage />
        </Suspense>
    );
}
...
function CallPage() {
    ...
    const channelName = searchParams.get('id'); // Using the query param ID as the channel name
