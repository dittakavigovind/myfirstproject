...
import { Sun, Sparkles, Droplet, ChevronLeft, ChevronRight, Star, Palette, Zap, Compass, Calendar as CalendarIcon } from 'lucide-react';
...
export default function WeeklyHoroscopePage() {
    ...
    const isCurrentWeek = (date) => {
        const now = new Date();
        const startNow = startOfWeek(now, { weekStartsOn: 0 });
        const startCurrent = startOfWeek(date, { weekStartsOn: 0 });
        return startNow.getTime() === startCurrent.getTime();
    };
