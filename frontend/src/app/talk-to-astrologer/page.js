    ...
    return (
        <div className="min-h-screen bg-slate-50 pb-20">
            ...
            <div className="relative text-white">
                ...
                {/* Foreground Content */}
                <div className="relative z-10 max-w-6xl mx-auto flex flex-col items-center pt-16 pb-32 px-6">
                    <motion.div
                    ...
                    >
                        ...
                        <h1 className="text-3xl md:text-5xl font-black mb-3 leading-tight tracking-tight">
                            Talk to <span className="text-transparent bg-clip-text bg-gradient-to-r from-astro-yellow via-amber-200 to-orange-300">Astrologers</span>
                        </h1>
