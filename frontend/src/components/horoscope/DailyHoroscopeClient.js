...
import { Droplet, Calendar as CalendarIcon, Palette, Zap, Star } from 'lucide-react';
...
export default function DailyHoroscopeClient() {
    ...
    useEffect(() => {
        const fetchContent = async () => {
            try {
                const res = await API.get('/page-content/daily-horoscope');
                ...
                console.error("Failed to fetch daily horoscope page content:", err);
            }
        };
        fetchContent();
    }, []);
